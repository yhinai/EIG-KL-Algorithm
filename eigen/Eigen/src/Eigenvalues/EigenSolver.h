...
template<typename _MatrixType> class EigenSolver
{
  public:
    ...
    explicit EigenSolver(const EigenBase<InputType>& matrix, bool computeEigenvectors = false)
    ...
    /** \brief Computes eigendecomposition of given matrix. 
      ...
      */
    template<typename InputType>
    EigenSolver& compute(const EigenBase<InputType>& matrix, bool computeEigenvectors = false);
